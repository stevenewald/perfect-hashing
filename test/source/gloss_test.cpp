...
TEST_CASE("Map many ints to int", "[library]")
{
    static constexpr auto TEST = std::array{
        ...
        //  std::pair<uint32_t, uint8_t>{6,  16},
        // std::pair<uint32_t, uint8_t>{7,  17},
        //  std::pair<uint32_t, uint8_t>{8,  18},
        // std::pair<uint32_t, uint8_t>{9,  19},
        //  std::pair<uint32_t, uint8_t>{10, 20}
    };
